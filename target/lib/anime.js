    ...
    function anime(params) {
        ...
        function setAnimationsProgress(insTime) {
            ...
            var _loop_2 = function () {
                ...
                var tween = tweens.filter(function (t) { return (insTime < t.end); })[0] || tweens[arrayLength(tweens) - 1];
                var isPath_1 = tween.isPath;
                ...
                var progress = recomposeValue(tween.to.numbers.map(function (number, p) {
                    var start = isPath_1 ? 0 : tween.from.numbers[p];
